...
<p style="margin:0"> <a style="margin:0; font-size:100%; font-weight:bold">Does Internet Expansion Improve Employment and Health Outcomes? Evidence from Broadband Rollout in Kenya</a> <br> Emilien Akotenou <br><button class="accordion">Abstract</button><div class="panel" style="background-color: #F1F1F1; color: #666; padding: 10px;"><p>This paper investigates how the expansion of broadband internet infrastructure influences labor market and reproductive health outcomes in Kenya. Using the surge expansion of fiber-optic backbone nodes in 2019 and repeated cross-sectional data from the Kenya Demographic and Health Surveys (2009–2022), I adopt a difference-in-differences approach to estimate the causal impact of improved internet connectivity on women's labor market participation and reproductive health behavior. I find that access to fast internet significantly increases employment among women, particularly in non-agricultural sectors. This employment effect is associated with a reduction in the total number of children ever born and shifts in the timing of reproductive events, including delayed age at first intercourse. I also find evidence of increased use of certain contraceptive methods, suggesting greater exposure to family planning information as a complementary mechanism. These findings suggest that internet infrastructure can reshape fertility behavior through both economic empowerment and behavioral change.</p></div><p style="margin:0"><button class="accordion">Download</button><div class="panel" style="background-color: #F1F1F1; color: #666; padding: 10px;"><p><a href="/job_market_paper.pdf">Paper</a></p></div><p style="margin:0"><button class="accordion">BibTeX citation</button><div class="panel" style="background-color: #F1F1F1; color: #666; padding: 10px;"><p><pre><code>@unpublished{akotenou2025internet,
